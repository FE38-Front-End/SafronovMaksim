...
// 1.При нажатии на точку два раза все обнуляется
// 2.Сделать невозможным поставить несколько знаков подряд
// 3.Сделать возможным начать написание со знака '-'
// 4.Если ввожу числа после вычисления начинать с нуля